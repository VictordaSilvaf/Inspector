...
Run `vendor/bin/sail bin pest --update-shards` to measure the time of each test. Run `vendor/bin/sail bin pest --shard=1/4` in each job of the CI, and change the first number for each job.
